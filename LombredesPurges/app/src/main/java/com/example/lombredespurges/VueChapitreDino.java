...
public class VueChapitreDino extends Fragment{
    ...
    private void gestionÉtape2(int choix){
        ...
        if(choix == 1){
            ...
            texteContenueChapitre.setText(R.string.chapitre2_1Dino);
            btnChoix1.setText(R.string.choix2_1_1);
            btnChoix2.setText(R.string.choix2_1_2);
            btnChoix3.setText(R.string.choix2_1_3);
            chapitreCourante = "2_1";
        }else if(choix == 2){
            txtNumeroChapitre.setText("2");
            texteContenueChapitre.setText(R.string.chapitre2_2Dino);
            btnChoix1.setText(R.string.choix2_2_1);
            btnChoix2.setText(R.string.choix2_2_2);
            btnChoix3.setText(R.string.choix2_2_3);
            chapitreCourante = "2_2";
        }else if (choix == 3){
            txtNumeroChapitre.setText("2");
            texteContenueChapitre.setText(R.string.chapitre2_3Dino);
            btnChoix1.setText(R.string.choix2_3_1);
            btnChoix2.setText(R.string.choix2_3_2);
            btnChoix3.setText(R.string.choix2_3_3);
        ...
        if(choix == 1)  {
            ...
            if (chapitreCourante.equals("2_1") || chapitreCourante.equals("2_2")){
                ...
                if (!combatFinit) {
                    ...
                    btnChoix1.setText(R.string.choix3_1_1);
                    btnChoix2.setText(R.string.choix3_1_2);
                    btnChoix3.setText(R.string.choix3_1_3);
                ...
                if (!combatFinit) {
                    ...
                    btnChoix1.setText(R.string.choix3_6_1);
                    btnChoix2.setText(R.string.choix3_6_2);
                    btnChoix3.setText(R.string.choix3_6_3);
            ...
            if(chapitreCourante.equals("2_1") || chapitreCourante.equals("2_2")){
                ...
                btnChoix1.setText(R.string.choix3_2_1);
                btnChoix2.setText(R.string.choix3_2_2);
                btnChoix3.setText(R.string.choix3_2_3);
                chapitreCourante = "3_2";
            }else if(chapitreCourante.equals("2_3")){
                txtNumeroChapitre.setText("3");
                texteContenueChapitre.setText(R.string.chapitre3_5Dino);
                btnChoix1.setText(R.string.choix3_5_1);
                btnChoix2.setText(R.string.choix3_5_2);
                btnChoix3.setText(R.string.choix3_5_3);
    ...
    private void gestionÉtape4(int choix){
        if(choix == 1){
            ...
            btnChoix1.setText(R.string.choix4_1_1);
            btnChoix2.setText(R.string.choix4_1_2);
            btnChoix3.setText(R.string.choix4_1_3);
            chapitreCourante = "4_1";
        }else if(choix == 3){
            txtNumeroChapitre.setText("4");
            texteContenueChapitre.setText(R.string.chapitre4_2Dino);
            btnChoix1.setText(R.string.choix4_2_1);
            btnChoix2.setText(R.string.choix4_2_2);
            btnChoix3.setText(R.string.choix4_2_3);
    ...
    private void gestionÉtape5(int choix){
        if(choix == 1){
            ...
            if(chapitreCourante.equals("4_1")){
                cheminFinal(R.string.bravo,R.string.chapitrefin2Dino);
            }else if(chapitreCourante.equals("4_2")){
